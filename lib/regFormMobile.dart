...
class regFormMobile extends StatefulWidget {
  const regFormMobile({Key? key}) : super(key: key);

  @override
  State<regFormMobile> createState() => _regFormMobileState();
}

class _regFormMobileState extends State<regFormMobile> {
              ...
              Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Beginning of form entry section. Unlike the desktop version,
                    // This is only one column instead of three rows
